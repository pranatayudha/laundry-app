...
const kPrimaryColor = Color.fromARGB(255, 36, 195, 207);
...
final otpInputDecoration = InputDecoration(
  ...
  contentPadding:
      EdgeInsets.symmetric(vertical: getProportionateScreenWidth(7)),
...
var mTitleStyle20 = GoogleFonts.inter(
    fontWeight: FontWeight.w600, color: mTitleColor, fontSize: 20);
...
var mTitleBlue20 = GoogleFonts.inter(
    fontWeight: FontWeight.w600, color: mBlueColor2, fontSize: 20);
...
var mItemInvoice = GoogleFonts.inter(
    fontWeight: FontWeight.w400, color: mTitleColor, fontSize: 14);

var mItemIsPaidOff = GoogleFonts.inter(
    fontWeight: FontWeight.w400, color: kColorLightGreen, fontSize: 14);

var mItemIsNotPaidOff = GoogleFonts.inter(
    fontWeight: FontWeight.w400, color: kColorOrange, fontSize: 14);
